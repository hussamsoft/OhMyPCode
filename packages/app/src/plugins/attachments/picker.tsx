...
import type { PluginAttachmentItem, PluginAttachmentSourceContribution } from "@ohmypcode/plugin";
import { searchPluginAttachments } from "@ohmypcode/plugin/client/host";
