...
declare global {
  interface Window {
    ...
    __OMPCODE_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __OMPCODE_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
window.__OMPCODE_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__OMPCODE_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
