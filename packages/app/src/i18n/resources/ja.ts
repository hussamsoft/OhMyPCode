...
export const ja: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "Vibe ワーカー モード",
      toolsGroupLabel: "ツール",
      toolsSearchKeywords: "ツール選択 有効なツール",
      settingOn: "オン",
      settingOff: "オフ",
    },
  },
  ...
  agentControls: {
    ...
    access: {
      title: "アクセス",
      hint: "次の OMP セッションの承認レベル",
      searchPlaceholder: "アクセスレベルを検索...",
      selectWithValue: "アクセスレベルを選択（{{value}}）",
      unknown: "不明",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "OMP モードを選択（{{value}}）",
      switching: "OMP モードを切り替え中",
      settings: "設定",
      openSettings: "OMP 設定を開く",
      behavior: "動作",
      startup: "起動",
      startsNewSession: "新しいセッションを開始",
      tools: "ツール",
      openTools: "OMP ツールを開く",
      toolCount: "{{enabled}}/{{total}} ツール",
      toolsUnavailable: "ツール選択は利用できません",
      toolsUnavailableSaved: "保存済みのツール {{count}} 件を保持しています",
      toolSource: {
        native: "ネイティブ",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      searchTools: "ツールを検索...",
      noTools: "一致するツールはありません。",
      loadingTools: "ツールを読み込み中...",
      required: "必須",
      toolAccessibleName: "{{label}} ツール",
      selectFeature: "{{label}} を選択（{{value}}）",
      default: "デフォルト",
      on: "オン",
      off: "オフ",
    },
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}} 個の時間枠",
      recentActivityChart: "最近のリクエストアクティビティのチャート",
      earlier: "以前",
      now: "現在",
      modelPerformance: "モデルのパフォーマンス",
      allRoutedModels: "ルーティングされたすべてのモデル",
      ...
      details: {
        failed: "{{value}} 件失敗",
        generated: "{{value}} 件生成",
        unpricedRequests: "{{value}} 件の未価格設定リクエスト",
        estimatedSavings: "{{value}} の推定節約",
        averageTtft: "平均 TTFT {{value}}",
      },
      noHost: {
        title: "ホストが接続されていません",
        description: "OMP 使用状況データを読み込むにはデスクトップデーモンを接続してください。",
      },
      loadingStatistics: "OMP 統計を読み込み中...",
      statisticsUnavailable: "統計は利用できません",
      loadingAccountLimits: "アカウント制限を読み込み中...",
      accountLimitsUnavailable: "アカウント制限は利用できません",
      noAccountLimits: {
        title: "OMP アカウント制限がありません",
        description: "OMP は認証済みプロバイダの使用制限を返しませんでした。",
      },
      refresh: "更新",
      tryAgain: "再試行",
    },
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "アクティブなセッションは OhMyPCode です",
      fastOn: "高速モードオン",
      fastOff: "高速モードオフ",
      fastToggleDisabled: "このエージェントでは高速モードは利用できません",
      rename: "セッション名を変更",
      tui: "OMP TUI を開く（プラン、目標、vibe モード）",
      tuiDisabled: "OMPランタイムは利用できません",
      usage: "OMP 使用量",
      collab: "OMP コラボレーション",
      collabDisabled: "OMPコラボレーションは利用できません",
      terminals: "ターミナルを開く",
      stateLabel: "状態",
      modelLabel: "モデル",
      thinkingLabel: "思考",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "このワークスペースはOhMyPCodeワークツリーとして作成されていないため、アーカイブはここでは利用できません",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "組み込みデーモンを管理",
        hint: "OhMyPCodeが組み込みデーモンを起動・停止できるようにする",
        pauseTitle: "組み込みデーモンを一時停止",
        pauseMessage:
          "これにより組み込みデーモンが即座に停止します。組み込みデーモンに接続されている実行中のエージェントとターミナルが停止されます。",
        pauseAndStop: "一時停止して停止",
        registrationFailed:
          "組み込みデーモンは起動しましたが、OhMyPCodeがlocalhostの接続を保存できませんでした。デーモン管理をオフにしてから再度オンにするか、localhostを手動で追加してください。",
        pausedStopFailed:
          "組み込みデーモン管理は一時停止されましたが、OhMyPCodeがデーモンを停止できませんでした。",
        updateFailed: "組み込みデーモン管理を更新できません。",
      },
      keepRunning: {
        title: "終了後もデーモンを実行し続ける",
        hint: "OhMyPCodeを終了してもデーモンは実行し続けます",
      },
      logs: {
        title: "ログファイル",
        modalTitle: "デーモンログ",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon上のRosettaでOhMyPCodeのIntelビルドを実行しています。",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "OhMyPCode CLIをインストールできません。",
      },
    },
  },
  rootError: {
    title: "OhMyPCode で問題が発生しました。",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "OMP セッションをインポート",
        description: "ターミナルで開始した OMP セッションを開く",
      },
      connectProviders: {
        title: "プロバイダーを接続",
        description: "Anthropic、OpenAI、OpenRouter などにサインイン",
      },
      pairDevice: {
        title: "デバイスをペアリング",
        description: "Paseo iPhone アプリをこのホストとペアリング",
      },
    },
    ompGithub: "GitHub の Oh My Pi",
  },
  projectPicker: {
    placeholder: "入力して検索...",
    browse: "参照…",
  ...
  onboarding: {
    title: "OhMyPCodeへようこそ",
    subtitle: "OMP を実行しているコンピューターに接続",
    actions: {
      settings: "設定",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "直接接続",
      helper: "OhMyPCodeサーバーのアドレスを入力してください。",
      fields: {
        host: "ホスト",
        port: "ポート",
        password: "パスワード",
    ...
    remoteSsh: {
      title: "リモート SSH",
      helper: "リモートホストで動作する OhMyPCode デーモンに接続します。",
      fields: {
        target: "SSH ホスト",
      },
      actions: {
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "OhMyPCodeを{{count}}回呼び出し",
      other: "OhMyPCodeを{{count}}回呼び出し",
    },
    and: "および",
  },
  renameModal: {
  ...
  ompProviders: {
    ...
    reconnect: "再接続",
    disconnect: "切断",
    disconnectConfirm: "{{name}} を OMP から切断しますか？",
    disconnectInTui: "OMP TUI で /logout を使用して切断します",
    stillConnected: "環境変数または models.yml により、引き続き接続されています",
    updateHost: "OMP モデルプロバイダーを管理するにはこのホストを更新してください",
    ...
    noneConnected: "OMP の使用を開始するにはモデルプロバイダーを接続してください",
    yes: "はい",
    no: "いいえ",
    picker: {
      connect: "モデルプロバイダーを接続",
    },
  },
  ompStatistics: {
    errors: {
      hostDisconnected: "ホストに接続されていません",
      updateHost: "OMP 統計を読み込むにはホストを更新してください",
      unavailable: "OMP 統計を利用できません",
    },
  },
  settings: {
    title: "設定",
    ...
    notifications: {
      ...
      sentDescription: "OhMyPCode が通知をオペレーティングシステムに渡しました。",
    ...
    metadataGeneration: {
      ...
      automatic: "自動",
      preferred: "手動",
      automaticHint: "OhMyPCode が利用可能な高速モデルを選択します",
      preferredHint: "OhMyPCode が使用するモデルを選択します",
      model: "モデル",
      fallbackHint: "利用できない場合、OhMyPCode は別の利用可能なモデルを使用します",
      docs: "ドキュメント",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "このコンピューターのOhMyPCodeを更新します",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "OhMyPCodeスキルを更新しますか？",
        updateFallback: "バンドルされたスキルをマシンに同期します。",
        uninstallTitle: "OhMyPCodeスキルをアンインストールしますか？",
        uninstallMessage:
          "~/.agents、~/.claude、~/.codexからすべてのOhMyPCodeオーケストレーションスキルを削除します。",
        choose: "スキルを選択",
        chooseAll: "すべてのスキル",
        chooseAllHint:
      ...
      orchestration: {
        ...
        enableTools: {
          title: "OhMyPCodeツールを有効にする",
          hint: "エージェントがワークツリー、エージェント、スケジュールを管理できるようになります",
          accessibilityLabel: "OhMyPCodeツールを有効にする",
        },
        systemPrompt: {
          title: "システムプロンプト",
      ...
      ompCollab: {
        title: "OMP コラボレーション",
        description: "実行中の OMP コラボレーションホストまたは既存の OMP セッションを共有します。",
        securityNote:
          "共有リンクは、所持者が使用できる暗号化済み認証情報です。リンクは直接コピーされ、アプリには表示されません。",
        openUsage: "使用状況を開く",
        refreshHosts: "ホストを更新",
        hostDisconnected: "ホストに接続されていません",
        hostDisconnectedHint: "OMP コラボレーションを管理するには、このホストに接続してください。",
        updateRequired: "ホストの更新が必要です",
        updateRequiredHint:
          "OMP コラボレーションと暗号化共有を有効にするには、このホストを更新してください。",
        listFailed: "OMP ホストを一覧表示できません",
        listFailedHint: "実行中のホスト一覧をもう一度更新してください。",
        activeHosts: "実行中のコラボレーションホスト",
        refreshPrompt: "更新すると、実行中の OMP コラボレーションホストを検索します。",
        noActiveHosts: "実行中の OMP コラボレーションホストは見つかりませんでした。",
        savedSessions: "保存済み OMP セッション",
        savedSessionsHint: "既存の OMP セッションから暗号化スナップショットリンクを作成します。",
        noSavedSessions: "保存済みセッション ID を持つ OMP セッションはありません。",
        participants: "参加者 {{count}} 人",
        busy: "処理中",
        inputRequired: "入力が必要",
        reconnecting: "リレーに再接続中",
        viewOnly: "閲覧のみ",
        controlAvailable: "操作可能",
        viewOnlyHint: "このホストでは閲覧リンクのみ許可されています。",
        hostFallbackWithPid: "OMP ホスト · PID {{pid}}",
        hostFallback: "OMP ホスト",
        copyViewLink: "閲覧リンクをコピー",
        copyControlLink: "操作リンクをコピー",
        sessionFallback: "OMP セッション · {{id}}",
        copyEncryptedShare: "暗号化共有をコピー",
        viewLinkCopied: "閲覧専用リンク",
        controlLinkCopied: "操作リンク",
        encryptedShareCopied: "暗号化セッションリンク",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "このホストはオフラインです。OhMyPCodeが自動再接続します。再起動は、ホストがオンラインに戻ってから行ってください。",
          requestFailedTitle: "エラー",
          requestFailedMessage:
            "再起動リクエストの送信に失敗しました。OhMyPCodeは自動的に再接続します。ホストがオンラインになったら再試行してください。",
          dialogFailedMessage: "再起動確認ダイアログを開けませんでした。",
        },
        update: {
          desktopManagedHint:
            "このデーモンはOhMyPCode Desktopによって管理されています。ホスト上のOhMyPCode Desktopを更新してください。",
          title: "デーモンを更新",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OhMyPCodeがプロセスを監督し、$PASEO_PORTを通じてポートを割り当てます",
        actions: {
          add: "スクリプトを追加",
          edit: "編集",
          remove: "削除",
      ...
      metadata: {
        title: "メタデータ生成",
        info: "OhMyPCodeがメタデータ生成に使うAIプロンプトへ追加する、プロジェクト固有の指示です。ブランチ名、コミット形式、PR形式など、チームの規約を反映するために使います。",
        branchName: "ブランチ名",
