...
export const ko: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "Vibe 모드 워커",
      toolsGroupLabel: "도구",
      toolsSearchKeywords: "도구 선택 사용 가능한 도구",
      settingOn: "켜짐",
      settingOff: "꺼짐",
    },
  },
  ...
  agentControls: {
    ...
    access: {
      title: "접근",
      hint: "다음 OMP 세션의 승인 수준",
      searchPlaceholder: "접근 수준 검색...",
      selectWithValue: "접근 수준 선택 ({{value}})",
      unknown: "알 수 없음",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "OMP 모드 선택 ({{value}})",
      switching: "OMP 모드 전환 중",
      settings: "설정",
      openSettings: "OMP 설정 열기",
      behavior: "동작",
      startup: "시작",
      startsNewSession: "새 세션 시작",
      tools: "도구",
      openTools: "OMP 도구 열기",
      toolCount: "{{enabled}}/{{total}} 도구",
      toolsUnavailable: "도구 선택을 사용할 수 없음",
      toolsUnavailableSaved: "저장된 도구 {{count}}개 유지",
      toolSource: {
        native: "네이티브",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      required: "필수",
      toolAccessibleName: "{{label}} 도구",
      selectFeature: "{{label}} 선택 ({{value}})",
      default: "기본값",
      on: "켜짐",
      off: "꺼짐",
    },
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}}개의 시간 윈도우",
      recentActivityChart: "최근 요청 활동 차트",
      earlier: "이전",
      now: "현재",
      modelPerformance: "모델 성능",
      allRoutedModels: "라우팅된 모든 모델",
      ...
      metrics: {
        requests: "요청",
        tokensRouted: "라우팅된 토큰",
        estimatedCost: "예상 비용",
        cacheHitRate: "캐시 적중률",
        generationSpeed: "생성 속도",
      },
      details: {
        failed: "{{value}}건 실패",
        generated: "{{value}} 생성됨",
        unpricedRequests: "가격 미지정 요청 {{value}}건",
        estimatedSavings: "예상 절감 {{value}}",
        averageTtft: "평균 TTFT {{value}}",
      },
      noHost: {
        title: "연결된 호스트가 없음",
        description: "OMP 사용량 데이터를 불러오려면 데스크톱 데몬을 연결하세요.",
      },
      loadingStatistics: "OMP 통계 불러오는 중...",
      statisticsUnavailable: "통계를 사용할 수 없음",
      loadingAccountLimits: "계정 한도 불러오는 중...",
      accountLimitsUnavailable: "계정 한도를 사용할 수 없음",
      noAccountLimits: {
        title: "OMP 계정 한도가 없음",
        description: "OMP가 인증된 공급자에 대한 사용 한도를 반환하지 않았습니다.",
      },
      refresh: "새로 고침",
      tryAgain: "다시 시도",
    },
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "활성 세션은 OhMyPCode입니다",
      fastOn: "고속 모드 켜짐",
      fastOff: "고속 모드 꺼짐",
      fastToggleDisabled: "이 에이전트에서는 고속 모드를 사용할 수 없습니다",
      rename: "세션 이름 변경",
      usage: "OMP 사용량",
      collab: "OMP 협업",
      collabDisabled: "OMP 협업을 사용할 수 없습니다",
      terminals: "터미널 열기",
      tui: "OMP TUI 열기(계획, 목표 및 vibe 모드)",
      tuiDisabled: "OMP 런타임을 사용할 수 없습니다",
      stateLabel: "상태",
      modelLabel: "모델",
      thinkingLabel: "사고",
    },
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "이 워크스페이스가 OhMyPCode 워크트리로 생성되지 않아 여기서 보관을 사용할 수 없습니다",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        title: "내장 데몬 관리",
        hint: "OhMyPCode가 내장 데몬을 시작하고 중지하도록 허용합니다",
      ...
      keepRunning: {
        ...
        hint: "OhMyPCode를 종료해도 데몬이 계속 실행됩니다",
      },
      logs: {
        title: "로그 파일",
        modalTitle: "데몬 로그",
    ...
    rosetta: {
      ...
      runningIntel: "Apple Silicon에서 Rosetta로 OhMyPCode의 Intel 빌드를 실행하고 있습니다.",
      highCpu:
    ...
    integrations: {
      cli: {
        ...
        installFailed: "OhMyPCode CLI를 설치할 수 없습니다.",
      },
    },
  },
  rootError: {
    title: "OhMyPCode에 문제가 발생했습니다.",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "OMP 세션 가져오기",
        description: "터미널에서 시작한 OMP 세션 열기",
      },
      connectProviders: {
        title: "프로바이더 연결",
        description: "Anthropic, OpenAI, OpenRouter 등에 로그인",
      },
      pairDevice: {
        title: "기기 페어링",
        description: "Paseo iPhone 앱을 이 호스트와 페어링",
      },
    },
    ompGithub: "GitHub의 Oh My Pi",
  },
  projectPicker: {
  ...
  onboarding: {
    title: "OhMyPCode에 오신 것을 환영합니다",
    subtitle: "OMP를 실행 중인 컴퓨터에 연결",
    actions: {
      settings: "설정",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "직접 연결",
      helper: "OhMyPCode 서버의 주소를 입력하세요.",
      fields: {
        host: "호스트",
        port: "포트",
        password: "비밀번호",
    ...
    remoteSsh: {
      title: "원격 SSH",
      helper: "원격 호스트에서 실행 중인 OhMyPCode 데몬에 연결합니다.",
      fields: {
        target: "SSH 호스트",
      },
      actions: {
    ...
    device: {
      ...
      relayDocs: "릴레이 작동 방식",
      relayDocsAccessibility: "OhMyPCode 릴레이 작동 방식 읽기",
      enableRelay: "릴레이 활성화",
      enablingRelay: "활성화 중...",
      notNow: "지금은 아님",
      directConnectionHint:
        "릴레이 없이 TCP, Tailscale 또는 다른 VPN을 통해 직접 연결하세요. QR 코드가 생성되지 않습니다.",
      updateRequired: "릴레이를 활성화하려면 이 호스트를 업데이트하세요.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "OhMyPCode를 {{count}}회 호출함",
      other: "OhMyPCode를 {{count}}회 호출함",
    },
    and: "그리고",
  },
  renameModal: {
  ...
  ompProviders: {
    ...
    reconnect: "다시 연결",
    disconnect: "연결 해제",
    disconnectConfirm: "{{name}}을(를) OMP에서 연결 해제할까요?",
    disconnectInTui: "OMP TUI에서 /logout으로 연결을 해제하세요",
    stillConnected: "환경 변수 또는 models.yml을 통해 계속 연결되어 있습니다",
    updateHost: "OMP 모델 프로바이더를 관리하려면 이 호스트를 업데이트하세요",
    ...
    completed: "연결됨",
    failed: "로그인 실패",
    searchPlaceholder: "프로바이더 검색",
    empty: "프로바이더를 찾을 수 없습니다",
    noneConnected: "OMP를 사용하려면 모델 프로바이더를 연결하세요",
    yes: "예",
    no: "아니요",
    picker: {
      connect: "모델 프로바이더 연결",
  ...
  ompStatistics: {
    errors: {
      hostDisconnected: "호스트가 연결되지 않았습니다",
      updateHost: "OMP 통계를 불러오려면 호스트를 업데이트하세요",
      unavailable: "OMP 통계를 사용할 수 없습니다",
    },
  },
  settings: {
    title: "설정",
    ...
    notifications: {
      ...
      sentDescription: "OhMyPCode가 알림을 운영 체제에 전달했습니다.",
    ...
    metadataGeneration: {
      ...
      automatic: "자동",
      preferred: "수동",
      automaticHint: "OhMyPCode가 사용 가능한 빠른 모델을 선택합니다",
      preferredHint: "OhMyPCode에서 사용할 모델을 선택하세요",
      model: "모델",
      fallbackHint: "사용할 수 없으면 OhMyPCode가 다른 사용 가능한 모델을 사용합니다",
      docs: "문서",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "브라우저 탭은 OhMyPCode 전체에서 로그인 및 사이트 데이터를 공유합니다.",
        clear: "브라우저 데이터 지우기",
        clearing: "삭제 중...",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "이 컴퓨터의 OhMyPCode를 업데이트합니다",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "OhMyPCode 스킬을 업데이트할까요?",
        updateFallback: "번들된 스킬을 내 컴퓨터에 동기화합니다.",
        uninstallTitle: "OhMyPCode 스킬을 제거할까요?",
        uninstallMessage:
          "~/.agents, ~/.claude, ~/.codex에서 모든 OhMyPCode 오케스트레이션 스킬을 제거합니다.",
        choose: "스킬 선택",
        chooseAll: "모든 스킬",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "OhMyPCode 도구 활성화",
          hint: "에이전트가 워크트리, 에이전트, 일정을 관리할 수 있습니다",
          accessibilityLabel: "OhMyPCode 도구 주입",
        },
        systemPrompt: {
          title: "시스템 프롬프트",
      ...
      ompCollab: {
        title: "OMP 협업",
        description: "활성 OMP 협업 호스트 또는 기존 OMP 세션을 공유합니다.",
        securityNote:
          "공유 링크는 보유자에게 권한을 주는 암호화된 자격 증명입니다. 링크는 바로 복사되며 앱에 표시되지 않습니다.",
        openUsage: "사용량 열기",
        refreshHosts: "호스트 새로 고침",
        hostDisconnected: "호스트가 연결되지 않았습니다",
        hostDisconnectedHint: "OMP 협업을 관리하려면 이 호스트에 연결하세요.",
        updateRequired: "호스트 업데이트 필요",
        updateRequiredHint: "OMP 협업과 암호화 공유를 사용하려면 이 호스트를 업데이트하세요.",
        listFailed: "OMP 호스트를 나열할 수 없습니다",
        listFailedHint: "활성 호스트 목록을 다시 새로 고침하세요.",
        activeHosts: "활성 협업 호스트",
        refreshPrompt: "새로 고침하여 실행 중인 OMP 협업 호스트를 찾으세요.",
        noActiveHosts: "활성 OMP 협업 호스트를 찾지 못했습니다.",
        savedSessions: "저장된 OMP 세션",
        savedSessionsHint: "기존 OMP 세션에서 암호화된 스냅샷 링크를 만듭니다.",
        noSavedSessions: "저장된 세션 ID가 있는 OMP 세션이 없습니다.",
        participants: "참여자 {{count}}명",
        busy: "작업 중",
        inputRequired: "입력 필요",
        reconnecting: "릴레이 재연결 중",
        viewOnly: "보기 전용",
        controlAvailable: "제어 가능",
        viewOnlyHint: "이 호스트는 보기 링크만 허용합니다.",
        hostFallbackWithPid: "OMP 호스트 · PID {{pid}}",
        hostFallback: "OMP 호스트",
        copyViewLink: "보기 링크 복사",
        copyControlLink: "제어 링크 복사",
        sessionFallback: "OMP 세션 · {{id}}",
        copyEncryptedShare: "암호화 공유 복사",
        viewLinkCopied: "읽기 전용 링크",
        controlLinkCopied: "제어 링크",
        encryptedShareCopied: "암호화된 세션 링크",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "이 호스트는 오프라인입니다. OhMyPCode가 자동으로 다시 연결하므로 다시 온라인이 될 때까지 기다린 후 재시작하세요.",
          requestFailedTitle: "오류",
          requestFailedMessage:
            "재시작 요청을 보내지 못했습니다. OhMyPCode가 자동으로 다시 연결하므로 호스트가 온라인으로 표시되면 다시 시도하세요.",
          dialogFailedMessage: "재시작 확인 대화 상자를 열 수 없습니다.",
        },
        update: {
          desktopManagedHint:
            "이 데몬은 OhMyPCode Desktop에서 관리됩니다. 호스트에서 OhMyPCode 데스크톱을 업데이트합니다.",
          title: "데몬 업데이트",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OhMyPCode가 프로세스를 감독하고 $PASEO_PORT를 통해 포트를 할당합니다",
        actions: {
          add: "스크립트 추가",
          edit: "편집",
          remove: "제거",
      ...
      metadata: {
        title: "메타데이터 생성",
        info: "OhMyPCode가 메타데이터를 생성하는 데 사용하는 AI 프롬프트에 주입되는 프로젝트별 지침 - 브랜치 이름, 커밋 스타일, PR 형식 같은 팀 규칙을 적용하는 데 사용하세요",
        branchName: "브랜치 이름",
