...
export const ptBR: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "modo Vibe trabalhadores",
      toolsGroupLabel: "Ferramentas",
      toolsSearchKeywords: "seleção de ferramentas ferramentas ativas",
      settingOn: "Ligado",
  ...
  agentControls: {
    ...
    access: {
      title: "Acesso",
      hint: "Nível de aprovação para a próxima sessão OMP",
      searchPlaceholder: "Buscar níveis de acesso...",
      selectWithValue: "Selecionar nível de acesso ({{value}})",
      unknown: "Desconhecido",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "Selecionar modo OMP ({{value}})",
      switching: "Alternando modo OMP",
      settings: "Configurações",
      openSettings: "Abrir configurações do OMP",
      behavior: "Comportamento",
      startup: "Inicialização",
      startsNewSession: "Inicia uma nova sessão",
      tools: "Ferramentas",
      openTools: "Abrir ferramentas do OMP",
      toolCount: "{{enabled}}/{{total}} ferramentas",
      toolsUnavailable: "Seleção de ferramentas indisponível",
      toolsUnavailableSaved: "{{count}} ferramentas salvas mantidas",
      toolSource: {
        native: "Nativa",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      noTools: "Nenhuma ferramenta corresponde.",
      loadingTools: "Carregando ferramentas...",
      required: "Obrigatória",
      toolAccessibleName: "Ferramenta {{label}}",
      selectFeature: "Selecionar {{label}} ({{value}})",
      default: "Padrão",
      on: "Ligado",
      off: "Desligado",
    },
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}} janelas por hora",
      recentActivityChart: "Gráfico de atividade recente de requisições",
      earlier: "Mais cedo",
      now: "Agora",
      modelPerformance: "Desempenho do modelo",
      allRoutedModels: "Todos os modelos roteados",
      ...
      metrics: {
        requests: "Requisições",
        tokensRouted: "Tokens roteados",
        estimatedCost: "Custo estimado",
        cacheHitRate: "Taxa de acerto de cache",
        generationSpeed: "Velocidade de geração",
      },
      details: {
        failed: "{{value}} falharam",
        generated: "{{value}} geradas",
        unpricedRequests: "{{value}} requisições sem preço",
        estimatedSavings: "{{value}} economia estimada",
        averageTtft: "TTFT médio {{value}}",
      },
      noHost: {
        title: "Nenhum host conectado",
        description: "Conecte o daemon do desktop para carregar os dados de uso do OMP.",
      },
      loadingStatistics: "Carregando estatísticas do OMP...",
      statisticsUnavailable: "Estatísticas indisponíveis",
      loadingAccountLimits: "Carregando limites da conta...",
      accountLimitsUnavailable: "Limites da conta indisponíveis",
      noAccountLimits: {
        title: "Sem limites de conta OMP",
        description: "O OMP não retornou limites de uso para um provedor autenticado.",
      },
      refresh: "Atualizar",
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "A sessão ativa é do OhMyPCode",
      fastOn: "Modo rápido ativado",
      fastOff: "Modo rápido desativado",
      fastToggleDisabled: "Modo rápido indisponível neste agente",
      rename: "Renomear sessão",
      usage: "Uso do OMP",
      tui: "Abrir o TUI do OMP (modos plano, objetivo e vibe)",
      tuiDisabled: "Ambiente de execução OMP indisponível",
      collab: "Colaboração OMP",
      collabDisabled: "Colaboração OMP indisponível",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Arquivar não está disponível aqui porque este workspace não foi criado como um worktree do OhMyPCode",
          mergePrNoForge:
  ...
  sidebar: {
    ...
    liveTerminals: {
      ...
      status: {
        working: "Em execução",
        needsInput: "Precisa de intervenção",
        finished: "Concluído",
        idle: "Ocioso",
      },
    },
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Permitir que o OhMyPCode inicie e pare o daemon integrado",
        ...
        registrationFailed:
          "O daemon integrado foi iniciado, mas o OhMyPCode não conseguiu salvar a conexão localhost. Desative e reative o gerenciamento do daemon ou adicione localhost manualmente.",
        pausedStopFailed:
          "O gerenciamento do daemon integrado foi pausado, mas o OhMyPCode não conseguiu parar o daemon.",
        updateFailed: "Não foi possível atualizar o gerenciamento do daemon integrado.",
      },
      keepRunning: {
        title: "Manter daemon em execução ao sair",
        hint: "O daemon continua em execução quando você sai do OhMyPCode",
      },
      logs: {
    ...
    permissions: {
      ...
      testNotification: {
        title: "Teste de notificação do OhMyPCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Não foi possível instalar a CLI do OhMyPCode.",
      },
    },
  },
  rootError: {
    title: "O OhMyPCode encontrou um problema.",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "Importar sessão OMP",
        description: "Abra uma sessão OMP iniciada no terminal",
      },
      connectProviders: {
        title: "Conectar provedores",
        description: "Entre no Anthropic, OpenAI, OpenRouter e mais",
      },
      pairDevice: {
        title: "Parear dispositivo",
        description: "Emparelhe o app Paseo para iPhone com este host",
      },
    },
    ompGithub: "Oh My Pi no GitHub",
  },
  projectPicker: {
  ...
  onboarding: {
    title: "Bem-vindo ao OhMyPCode",
    subtitle: "Conecte-se ao computador que executa o OMP",
    actions: {
      settings: "Configurações",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "Conexão direta",
      helper: "Informe o endereço de um servidor OhMyPCode.",
      fields: {
        host: "Host",
        port: "Porta",
        password: "Senha",
    ...
    remoteSsh: {
      title: "SSH remoto",
      helper: "Conecte-se a um daemon OhMyPCode no host remoto.",
      fields: {
        target: "Host SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Leia como o relay do OhMyPCode funciona",
      ...
      updateRequired: "Atualize este host para ativar o relay.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "chamou o OhMyPCode {{count}} vez",
      other: "chamou o OhMyPCode {{count}} vezes",
    },
    and: "e",
  },
  renameModal: {
  ...
  ompProviders: {
    ...
    disconnectConfirm: "Desconectar {{name}} do OMP?",
    disconnectInTui: "Desconecte com /logout na TUI do OMP",
    stillConnected: "Ainda conectado por uma variável de ambiente ou models.yml",
    updateHost: "Atualize este host para gerenciar provedores de modelos do OMP",
    ...
    empty: "Nenhum provedor encontrado",
    noneConnected: "Conecte um provedor de modelos para começar a usar o OMP",
    yes: "Sim",
    no: "Não",
    picker: {
      connect: "Conectar um provedor de modelos",
    },
  },
  ompStatistics: {
    errors: {
      hostDisconnected: "O host não está conectado",
      updateHost: "Atualize o host para carregar as estatísticas do OMP",
      unavailable: "As estatísticas do OMP não estão disponíveis",
    },
  },
  settings: {
    title: "Configurações",
    ...
    notifications: {
      ...
      sentDescription: "O OhMyPCode entregou a notificação ao sistema operacional.",
    ...
    metadataGeneration: {
      ...
      description:
        "Escolha o modelo usado pelo OhMyPCode para títulos de espaços de trabalho, nomes de branches, mensagens de commit e rascunhos de pull request",
      selection: "Seleção de modelo",
      automatic: "Automática",
      preferred: "Manual",
      automaticHint: "O OhMyPCode escolhe um modelo rápido disponível",
      preferredHint: "Escolha o modelo que o OhMyPCode usa",
      model: "Modelo",
      fallbackHint: "Se ele não estiver disponível, o OhMyPCode usa outro modelo disponível",
      docs: "Documentação",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "As abas do navegador compartilham logins e dados de sites no OhMyPCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "Isso atualiza o OhMyPCode neste computador",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Atualizar OhMyPCode skills?",
        updateFallback: "Sincronize as skills incluídas com sua máquina.",
        uninstallTitle: "Desinstalar OhMyPCode skills?",
        uninstallMessage:
          "Remove todas as skills de orquestração do OhMyPCode de ~/.agents, ~/.claude e ~/.codex.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Ativar ferramentas do OhMyPCode",
          hint: "Agentes poderão gerenciar worktrees, agentes e agendamentos",
          accessibilityLabel: "Injetar ferramentas do OhMyPCode",
        },
        systemPrompt: {
      ...
      ompCollab: {
        title: "Colaboração OMP",
        description: "Compartilhe hosts de colaboração OMP ativos ou uma sessão OMP existente.",
        securityNote:
          "Os links são credenciais criptografadas por posse. Eles são copiados diretamente e nunca aparecem no aplicativo.",
        openUsage: "Abrir Uso",
        refreshHosts: "Atualizar hosts",
        hostDisconnected: "O host não está conectado",
        hostDisconnectedHint: "Conecte-se a este host para gerenciar a colaboração OMP.",
        updateRequired: "Atualização do host necessária",
        updateRequiredHint:
          "Atualize este host para habilitar a colaboração OMP e o compartilhamento criptografado.",
        listFailed: "Não foi possível listar os hosts OMP",
        listFailedHint: "Tente atualizar novamente a lista de hosts ativos.",
        activeHosts: "Hosts de colaboração ativos",
        refreshPrompt: "Atualize para encontrar hosts de colaboração OMP em execução.",
        noActiveHosts: "Nenhum host de colaboração OMP ativo foi encontrado.",
        savedSessions: "Sessões OMP salvas",
        savedSessionsHint: "Crie um link de snapshot criptografado de uma sessão OMP existente.",
        noSavedSessions: "Não há sessões OMP com um ID de sessão salvo.",
        participants: "{{count}} participantes",
        busy: "Ocupado",
        inputRequired: "Entrada necessária",
        reconnecting: "Reconectando ao relay",
        viewOnly: "Somente leitura",
        controlAvailable: "Controle disponível",
        viewOnlyHint: "Este host permite apenas links de leitura.",
        hostFallbackWithPid: "Host OMP · PID {{pid}}",
        hostFallback: "Host OMP",
        copyViewLink: "Copiar link de leitura",
        copyControlLink: "Copiar link de controle",
        sessionFallback: "Sessão OMP · {{id}}",
        copyEncryptedShare: "Copiar compartilhamento criptografado",
        viewLinkCopied: "Link somente leitura",
        controlLinkCopied: "Link de controle",
        encryptedShareCopied: "Link de sessão criptografado",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "Este host está offline. O OhMyPCode reconecta automaticamente. Aguarde ele voltar a ficar online antes de reiniciar.",
          requestFailedTitle: "Erro",
          requestFailedMessage:
            "Falha ao enviar a solicitação de reinício. O OhMyPCode reconecta automaticamente. Tente novamente quando o host aparecer como online.",
          dialogFailedMessage: "Não foi possível abrir o diálogo de confirmação de reinício.",
        },
        update: {
          desktopManagedHint:
            "Este daemon é gerenciado pelo OhMyPCode Desktop. Atualize o OhMyPCode Desktop no host.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "O OhMyPCode supervisiona o processo e atribui uma porta via $PASEO_PORT",
        actions: {
      ...
      metadata: {
        title: "Geração de metadados",
        info: "Instruções específicas do projeto injetadas nos prompts de IA que o OhMyPCode usa para gerar metadados. Use-as para aplicar convenções da sua equipe, como nomes de branch, estilo de commit ou formato de PR",
