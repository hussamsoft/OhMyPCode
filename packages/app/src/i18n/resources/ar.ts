...
export const ar: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "وضع Vibe العمال",
      toolsGroupLabel: "الأدوات",
      toolsSearchKeywords: "تحديد الأدوات الأدوات المفعّلة",
      settingOn: "تشغيل",
      settingOff: "إيقاف",
    },
  },
  ...
  agentControls: {
    ...
    access: {
      title: "الوصول",
      hint: "مستوى الموافقة لجلسة OMP التالية",
      searchPlaceholder: "البحث في مستويات الوصول...",
      selectWithValue: "حدد مستوى الوصول ({{value}})",
      unknown: "غير معروف",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "حدد وضع OMP ({{value}})",
      switching: "تبديل وضع OMP",
      settings: "الإعدادات",
      openSettings: "فتح إعدادات OMP",
      behavior: "السلوك",
      startup: "بدء التشغيل",
      startsNewSession: "يبدأ جلسة جديدة",
      tools: "الأدوات",
      openTools: "فتح أدوات OMP",
      toolCount: "{{enabled}}/{{total}} أداة",
      toolsUnavailable: "اختيار الأدوات غير متاح",
      toolsUnavailableSaved: "تم الاحتفاظ بـ {{count}} من الأدوات المحفوظة",
      toolSource: {
        native: "أصلي",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      required: "مطلوب",
      toolAccessibleName: "أداة {{label}}",
      selectFeature: "حدد {{label}} ({{value}})",
      default: "افتراضي",
      on: "تشغيل",
      off: "إيقاف",
    },
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}} نافذة بالساعة",
      recentActivityChart: "مخطط نشاط الطلبات الأخير",
      earlier: "الأقدم",
      now: "الآن",
      modelPerformance: "أداء النماذج",
      allRoutedModels: "جميع النماذج الموجّهة",
      ...
      metrics: {
        requests: "الطلبات",
        tokensRouted: "الرموز الموجّهة",
        estimatedCost: "التكلفة المقدّرة",
        cacheHitRate: "معدل إصابة الذاكرة المؤقتة",
        generationSpeed: "سرعة التوليد",
      },
      details: {
        failed: "{{value}} فاشل",
        generated: "{{value}} تم توليدها",
        unpricedRequests: "{{value}} طلبات بدون تسعير",
        estimatedSavings: "{{value}} توفير مُقدَّر",
        averageTtft: "متوسط زمن أول رمز {{value}}",
      },
      noHost: {
        title: "لا يوجد مضيف متصل",
        description: "وصّل برنامج الحاسوب الرئيسي لتحميل بيانات استخدام OMP.",
      },
      loadingStatistics: "جارٍ تحميل إحصائيات OMP...",
      statisticsUnavailable: "الإحصائيات غير متوفرة",
      loadingAccountLimits: "جارٍ تحميل حدود الحساب...",
      accountLimitsUnavailable: "حدود الحساب غير متوفرة",
      noAccountLimits: {
        title: "لا توجد حدود لحساب OMP",
        description: "لم يُعد OMP حدود استخدام لمزود مُصادَق عليه.",
      },
      refresh: "تحديث",
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "الجلسة النشطة من OhMyPCode",
      fastOn: "الوضع السريع مفعّل",
      fastOff: "الوضع السريع معطّل",
      fastToggleDisabled: "الوضع السريع غير متاح لهذا الوكيل",
      rename: "إعادة تسمية الجلسة",
      usage: "استخدام OMP",
      collab: "تعاون OMP",
      collabDisabled: "تعاون OMP غير متاح",
      terminals: "فتح محطة طرفية",
      tui: "فتح واجهة OMP الطرفية (أوضاع الخطة والهدف وvibe)",
      tuiDisabled: "بيئة تشغيل OMP غير متاحة",
      stateLabel: "الحالة",
      modelLabel: "النموذج",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "الأرشيف غير متاح هنا لأنه لم يتم إنشاء مساحة العمل هذه كشجرة عمل OhMyPCode",
  ...
  sidebar: {
    ...
    liveTerminals: {
      title: "المحطات الطرفية النشطة",
      open: "فتح {{name}}، {{status}}",
      status: {
        working: "قيد العمل",
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "اسمح لـ OhMyPCode ببدء تشغيل البرنامج الخفي المدمج وإيقافه",
        ...
        pausedStopFailed:
          "تم إيقاف إدارة البرنامج الخفي المضمنة مؤقتًا، لكن لم يتمكن OhMyPCode من إيقاف البرنامج الخفي.",
        updateFailed: "غير قادر على تحديث إدارة البرنامج الخفي المضمنة.",
      },
      keepRunning: {
        title: "استمر في تشغيل البرنامج الخفي بعد الإقلاع عن التدخين",
        hint: "يستمر تشغيل Daemon عند إنهاء OhMyPCode",
      },
      logs: {
        title: "ملف السجل",
    ...
    rosetta: {
      ...
      runningIntel: "أنت تقوم بتشغيل إصدار Intel من OhMyPCode ضمن Rosetta على Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "اختبار الإخطار OhMyPCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "غير قادر على تثبيت OhMyPCodeCLI.",
      },
    },
  },
  rootError: {
    title: "واجه OhMyPCode مشكلة.",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "استيراد جلسة OMP",
        description: "افتح جلسة OMP بدأتَها في الطرفية",
      },
      connectProviders: {
        title: "توصيل مزودي النماذج",
        description: "سجّل الدخول إلى Anthropic وOpenAI وOpenRouter وغير ذلك",
      },
      pairDevice: {
        title: "إقران الجهاز",
        description: "قم بإقران تطبيق Paseo على iPhone بهذا المضيف",
      },
    },
    ompGithub: "Oh My Pi على GitHub",
  },
  projectPicker: {
  ...
  onboarding: {
    title: "مرحبا بكم في OhMyPCode",
    subtitle: "اتصل بالكمبيوتر الذي يشغّل OMP",
    actions: {
      settings: "إعدادات",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "اتصال مباشر",
      helper: "أدخل عنوان خادم OhMyPCode.",
      fields: {
        host: "Host",
        port: "ميناء",
    ...
    remoteSsh: {
      title: "SSH عن بُعد",
      helper: "الاتصال بخادم OhMyPCode يعمل على المضيف البعيد.",
      fields: {
        target: "مضيف SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "اقرأ كيفية عمل تتابع OhMyPCode",
      ...
      updateRequired: "حدّث هذا المضيف لتمكين التتابع.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "استدعى OhMyPCode {{count}} مرة",
      other: "استدعى OhMyPCode {{count}} مرات",
    },
    and: "و",
  },
  renameModal: {
  ...
  ompProviders: {
    title: "موفرو LLM",
    description: "صِل موفري النماذج بـ OMP. تبقى بيانات الاعتماد في خزنة OMP على هذا المضيف.",
    connected: "متصل",
    available: "متاح",
    connect: "اتصال",
    reconnect: "إعادة الاتصال",
    disconnect: "قطع الاتصال",
    disconnectConfirm: "قطع اتصال {{name}} من OMP؟",
    disconnectInTui: "افصل باستخدام /logout في واجهة OMP الطرفية",
    stillConnected: "لا يزال متصلاً من خلال متغير بيئة أو models.yml",
    updateHost: "حدّث هذا المضيف لإدارة موفري نماذج OMP",
    ...
    searchPlaceholder: "البحث في الموفرين",
    empty: "لم يتم العثور على موفرين",
    noneConnected: "صِل موفر نماذج لبدء استخدام OMP",
    yes: "نعم",
    no: "لا",
    picker: {
      connect: "صِل موفر نماذج",
    },
  },
  ompStatistics: {
    errors: {
      hostDisconnected: "المضيف غير متصل",
      updateHost: "حدّث المضيف لتحميل إحصاءات OMP",
      unavailable: "إحصاءات OMP غير متاحة",
    },
  },
  settings: {
    title: "إعدادات",
    ...
    notifications: {
      ...
      sentDescription: "سلّم OhMyPCode الإشعار إلى نظام التشغيل.",
      sendFailedTitle: "تعذر إرسال إشعار الاختبار",
    },
    hostSections: {
      projects: "المشاريع",
      connections: "اتصالات",
      llmProviders: "موفرو LLM",
    ...
    metadataGeneration: {
      ...
      description:
        "اختر النموذج الذي يستخدمه OhMyPCode لعناوين مساحات العمل وأسماء الفروع ورسائل الالتزام ومسودات طلبات السحب",
      selection: "اختيار النموذج",
      automatic: "تلقائي",
      preferred: "يدوي",
      automaticHint: "يختار OhMyPCode نموذجًا سريعًا متاحًا",
      preferredHint: "اختر النموذج الذي يستخدمه OhMyPCode",
      model: "النموذج",
      fallbackHint: "إذا لم يكن متاحًا، يستخدم OhMyPCode نموذجًا آخر متاحًا",
      docs: "الوثائق",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "تتشارك علامات تبويب المتصفح تسجيلات الدخول وبيانات المواقع عبر OhMyPCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "يؤدي هذا إلى تحديث OhMyPCode على هذا الكمبيوتر",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "تحديث مهارات OhMyPCode ؟",
        updateFallback: "مزامنة المهارات المجمعة لجهازك.",
        uninstallTitle: "إلغاء تثبيت مهارات OhMyPCode ؟",
        uninstallMessage: "يزيل جميع مهارات تنسيق OhMyPCode من ~/.agents ، ~/.claude ، ~/.codex.",
      ...
      ompCollab: {
        title: "تعاون OMP",
        description: "شارك مضيفي تعاون OMP النشطين أو جلسة OMP موجودة.",
        securityNote:
          "روابط المشاركة بيانات اعتماد مشفرة تعتمد على حيازتها. تُنسخ مباشرة ولا تظهر في التطبيق.",
        openUsage: "فتح الاستخدام",
        refreshHosts: "تحديث المضيفين",
        hostDisconnected: "المضيف غير متصل",
        hostDisconnectedHint: "اتصل بهذا المضيف لإدارة تعاون OMP.",
        updateRequired: "يلزم تحديث المضيف",
        updateRequiredHint: "حدّث هذا المضيف لتمكين تعاون OMP والمشاركة المشفرة.",
        listFailed: "تعذر عرض مضيفي OMP",
        listFailedHint: "حاول تحديث قائمة المضيفين النشطين مجددًا.",
        activeHosts: "مضيفو التعاون النشطون",
        refreshPrompt: "حدّث للعثور على مضيفي تعاون OMP قيد التشغيل.",
        noActiveHosts: "لم يتم العثور على مضيفي تعاون OMP نشطين.",
        savedSessions: "جلسات OMP المحفوظة",
        savedSessionsHint: "أنشئ رابط لقطة مشفرة من جلسة OMP موجودة.",
        noSavedSessions: "لا توجد جلسات OMP بمعرّف جلسة محفوظ.",
        participants: "{{count}} مشاركين",
        busy: "مشغول",
        inputRequired: "الإدخال مطلوب",
        reconnecting: "إعادة اتصال الترحيل",
        viewOnly: "عرض فقط",
        controlAvailable: "التحكم متاح",
        viewOnlyHint: "يسمح هذا المضيف بروابط العرض فقط.",
        hostFallbackWithPid: "مضيف OMP · PID {{pid}}",
        hostFallback: "مضيف OMP",
        copyViewLink: "نسخ رابط العرض",
        copyControlLink: "نسخ رابط التحكم",
        sessionFallback: "جلسة OMP · {{id}}",
        copyEncryptedShare: "نسخ المشاركة المشفرة",
        viewLinkCopied: "رابط للقراءة فقط",
        controlLinkCopied: "رابط التحكم",
        encryptedShareCopied: "رابط جلسة مشفر",
        shareFailed: "تعذر إنشاء رابط المشاركة.",
      },
      daemon: {
        rename: {
        ...
        restart: {
          ...
          offlineMessage:
            "هذا المضيف غير متصل.  يقوم OhMyPCode بإعادة الاتصال تلقائيًا - انتظر حتى يتم الاتصال بالإنترنت مرة أخرى قبل إعادة التشغيل.",
          requestFailedTitle: "خطأ",
          requestFailedMessage:
            "فشل في إرسال طلب إعادة التشغيل.  يقوم OhMyPCode بإعادة الاتصال تلقائيًا - حاول مرة أخرى بمجرد ظهور المضيف على أنه متصل بالإنترنت.",
          dialogFailedMessage: "غير قادر على فتح مربع حوار تأكيد إعادة التشغيل.",
        },
        update: {
          desktopManagedHint:
            "يدير OhMyPCode Desktop هذا البرنامج الخفي. حدّث OhMyPCode Desktop على المضيف.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "يشرف OhMyPCode على العملية ويعين منفذًا عبر $PASEO_PORT",
        actions: {
      ...
      metadata: {
        ...
        info: "تعليمات خاصة بالمشروع يتم إدخالها في الذكاء الاصطناعي الذي يستخدمه OhMyPCode لإنشاء بيانات التعريف - استخدمها لفرض اصطلاحات فريقك مثل تسمية الفرع أو نمط الالتزام أو تنسيق PR",
