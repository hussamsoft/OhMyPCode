export const en = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      settingOn: "On",
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "vibe mode workers",
      toolsGroupLabel: "Tools",
      toolsSearchKeywords: "tool selection enabled tools",
      settingOff: "Off",
    },
  },
  composer: {
  ...
  agentControls: {
    ...
    access: {
      title: "Access",
      hint: "Approval level for the next OMP session",
      searchPlaceholder: "Search access levels...",
      selectWithValue: "Select access level ({{value}})",
      unknown: "Unknown",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "Select OMP mode ({{value}})",
      switching: "Switching OMP mode",
      settings: "Settings",
      openSettings: "Open OMP settings",
      behavior: "Behavior",
      startup: "Startup",
      startsNewSession: "Starts new session",
      tools: "Tools",
      openTools: "Open OMP tools",
      toolCount: "{{enabled}}/{{total}} tools",
      toolsUnavailable: "Tool selection unavailable",
      toolsUnavailableSaved: "{{count}} saved tools kept",
      toolSource: {
        native: "Native",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      required: "Required",
      toolAccessibleName: "{{label}} tool",
      selectFeature: "Select {{label}} ({{value}})",
      default: "Default",
      on: "On",
      off: "Off",
    },
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}} hourly windows",
      recentActivityChart: "Recent request activity chart",
      earlier: "Earlier",
      now: "Now",
      modelPerformance: "Model performance",
      allRoutedModels: "All routed models",
      ...
      details: {
        ...
        unpricedRequests: "{{value}} unpriced requests",
        estimatedSavings: "{{value}} estimated savings",
        averageTtft: "{{value}} average TTFT",
      },
      noHost: {
        title: "No host connected",
        description: "Connect the desktop daemon to load OMP usage data.",
      },
      loadingStatistics: "Loading OMP statistics...",
      statisticsUnavailable: "Statistics unavailable",
      loadingAccountLimits: "Loading account limits...",
      accountLimitsUnavailable: "Account limits unavailable",
      noAccountLimits: {
        title: "No OMP account limits",
        description: "OMP did not return usage limits for an authenticated provider.",
      },
      refresh: "Refresh",
      tryAgain: "Try again",
    },
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "Active agent is an OhMyPCode session",
      fastOn: "Fast mode on",
      fastOff: "Fast mode off",
      fastToggleDisabled: "Fast mode is not available on this agent",
      rename: "Rename session",
      usage: "OMP usage",
      collab: "OMP collaboration",
      collabDisabled: "OMP collaboration unavailable",
      terminals: "Open terminal",
      tui: "Open OMP TUI (plan, goal and vibe modes)",
      tuiDisabled: "OMP runtime unavailable",
      stateLabel: "state",
      modelLabel: "model",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a OhMyPCode worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let OhMyPCode start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but OhMyPCode could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit OhMyPCode",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of OhMyPCode under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "OhMyPCode notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the OhMyPCode CLI.",
      },
    },
  },
  rootError: {
    title: "OhMyPCode ran into a problem.",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "Import OMP session",
        description: "Open an OMP session you started in a terminal",
      },
      connectProviders: {
        title: "Connect providers",
        description: "Sign in to Anthropic, OpenAI, OpenRouter and more",
      },
      pairDevice: {
        title: "Pair device",
        description: "Pair the Paseo iPhone app with this host",
      },
    },
    ompGithub: "Oh My Pi on GitHub",
  },
  projectPicker: {
  ...
  onboarding: {
    title: "Welcome to OhMyPCode",
    subtitle: "Connect to the computer running OMP",
    actions: {
      settings: "Settings",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a OhMyPCode server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a OhMyPCode daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how OhMyPCode relay works",
      ...
      updateRequired: "Update this host to enable relay.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called OhMyPCode {{count}} time",
      other: "called OhMyPCode {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  ompProviders: {
    title: "LLM providers",
    description: "Connect model providers to OMP. Credentials stay in OMP's vault on this host.",
    connected: "Connected",
    available: "Available",
    connect: "Connect",
    reconnect: "Reconnect",
    disconnect: "Disconnect",
    disconnectConfirm: "Disconnect {{name}} from OMP?",
    disconnectInTui: "Disconnect with /logout in the OMP TUI",
    stillConnected: "Still connected through an environment variable or models.yml",
    updateHost: "Update this host to manage OMP model providers",
    ...
    noneConnected: "Connect a model provider to start using OMP",
    yes: "Yes",
    no: "No",
    picker: {
  ...
  ompStatistics: {
    errors: {
      hostDisconnected: "Host is not connected",
      updateHost: "Update the host to load OMP statistics",
      unavailable: "OMP statistics are unavailable",
    },
  },
  settings: {
    title: "Settings",
    ...
    notifications: {
      ...
      sentDescription: "OhMyPCode handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model OhMyPCode uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "OhMyPCode picks a fast available model",
      preferredHint: "Choose the model OhMyPCode uses",
      model: "Model",
      fallbackHint: "If it is unavailable, OhMyPCode falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across OhMyPCode.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates OhMyPCode on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update OhMyPCode skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall OhMyPCode skills?",
        uninstallMessage:
          "Removes all OhMyPCode orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Enable OhMyPCode tools",
          hint: "Agents will be able to manage worktrees, agents and schedules",
          accessibilityLabel: "Inject OhMyPCode tools",
        },
        systemPrompt: {
          title: "System prompt",
      ...
      ompCollab: {
        title: "OMP collaboration",
        description: "Share active OMP collaboration hosts or an existing OMP session.",
        securityNote:
          "Share links are encrypted possession credentials. They are copied directly and never shown in the app.",
        openUsage: "Open Usage",
        refreshHosts: "Refresh hosts",
        hostDisconnected: "Host is not connected",
        hostDisconnectedHint: "Connect to this host to manage OMP collaboration.",
        updateRequired: "Host update required",
        updateRequiredHint: "Update this host to enable OMP collaboration and encrypted sharing.",
        listFailed: "Unable to list OMP hosts",
        listFailedHint: "Try refreshing the active host list again.",
        activeHosts: "Active collaboration hosts",
        refreshPrompt: "Refresh to find running OMP collaboration hosts.",
        noActiveHosts: "No active OMP collaboration hosts were found.",
        savedSessions: "Saved OMP sessions",
        savedSessionsHint: "Create an encrypted snapshot link from an existing OMP session.",
        noSavedSessions: "No OMP sessions with a saved session ID are available.",
        ...
        viewOnlyHint: "This host only permits view links.",
        hostFallbackWithPid: "OMP host · PID {{pid}}",
        hostFallback: "OMP host",
        copyViewLink: "Copy view link",
        copyControlLink: "Copy control link",
        sessionFallback: "OMP session · {{id}}",
        copyEncryptedShare: "Copy encrypted share",
        viewLinkCopied: "Read-only link",
        controlLinkCopied: "Control link",
        encryptedShareCopied: "Encrypted session link",
        shareFailed: "Unable to create the share link.",
      },
      daemon: {
        rename: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. OhMyPCode reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. OhMyPCode reconnects automatically-try again once the host shows as online.",
          dialogFailedMessage: "Unable to open the restart confirmation dialog.",
        },
        update: {
          desktopManagedHint:
            "This daemon is managed by OhMyPCode Desktop. Update OhMyPCode Desktop on the host.",
          title: "Update daemon",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OhMyPCode supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts OhMyPCode uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
