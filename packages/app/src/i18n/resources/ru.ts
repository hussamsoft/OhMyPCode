...
export const ru: TranslationResources = {
  ...
  shell: {
    ...
    commandCenter: {
      ...
      vibeGroupLabel: "Vibe",
      vibeSearchKeywords: "режим Vibe воркеры",
      toolsGroupLabel: "Инструменты",
      toolsSearchKeywords: "выбор инструментов включенные инструменты",
      settingOn: "Вкл",
      settingOff: "Выкл",
    },
  },
  ...
  agentControls: {
    ...
    access: {
      title: "Доступ",
      hint: "Уровень подтверждения для следующей сессии OMP",
      searchPlaceholder: "Поиск уровней доступа...",
      selectWithValue: "Выбрать уровень доступа ({{value}})",
      unknown: "Неизвестно",
    },
    omp: {
      build: "Build",
      vibe: "Vibe",
      selectMode: "Выбрать режим OMP ({{value}})",
      switching: "Переключение режима OMP",
      settings: "Настройки",
      openSettings: "Открыть настройки OMP",
      behavior: "Поведение",
      startup: "Запуск",
      startsNewSession: "Начинает новую сессию",
      tools: "Инструменты",
      openTools: "Открыть инструменты OMP",
      toolCount: "{{enabled}}/{{total}} инструментов",
      toolsUnavailable: "Выбор инструментов недоступен",
      toolsUnavailableSaved: "Сохранённых инструментов осталось: {{count}}",
      toolSource: {
        native: "Нативный",
        paseo: "OhMyPCode",
        mcp: "MCP",
      ...
      noTools: "Нет подходящих инструментов.",
      loadingTools: "Загрузка инструментов...",
      required: "Обязательный",
      toolAccessibleName: "Инструмент {{label}}",
      selectFeature: "Выбрать {{label}} ({{value}})",
  ...
  usage: {
    ...
    screen: {
      ...
      hourlyWindows: "{{count}} часовых окон",
      recentActivityChart: "График недавней активности запросов",
      earlier: "Ранее",
      now: "Сейчас",
      modelPerformance: "Производительность модели",
      allRoutedModels: "Все маршрутизированные модели",
      ...
      metrics: {
        requests: "Запросы",
        tokensRouted: "Маршрутизированные токены",
        estimatedCost: "Расчётная стоимость",
        cacheHitRate: "Частота попаданий в кэш",
        generationSpeed: "Скорость генерации",
      },
      details: {
        failed: "{{value}} не удалось",
        generated: "{{value}} сгенерировано",
        unpricedRequests: "{{value}} запросов без цены",
        estimatedSavings: "{{value}} расчётная экономия",
        averageTtft: "Средний TTFT {{value}}",
      },
      noHost: {
        title: "Нет подключённого хоста",
        description: "Подключите десктопный демон для загрузки данных об использовании OMP.",
      },
      loadingStatistics: "Загрузка статистики OMP...",
      statisticsUnavailable: "Статистика недоступна",
      loadingAccountLimits: "Загрузка лимитов аккаунта...",
      accountLimitsUnavailable: "Лимиты аккаунта недоступны",
      noAccountLimits: {
        title: "Нет лимитов аккаунта OMP",
        description: "OMP не вернул лимиты использования для аутентифицированного провайдера.",
      },
      refresh: "Обновить",
      tryAgain: "Повторить",
    },
  ...
  omp: {
    strip: {
      providerLabel: "OMP",
      providerTooltip: "Активная сессия — OhMyPCode",
      fastOn: "Быстрый режим включён",
      fastOff: "Быстрый режим выключен",
      fastToggleDisabled: "Быстрый режим недоступен для этого агента",
      rename: "Переименовать сессию",
      usage: "Использование OMP",
      tui: "Открыть OMP TUI (режимы плана, цели и vibe)",
      tuiDisabled: "Среда выполнения OMP недоступна",
      collab: "Совместная работа OMP",
      collabDisabled: "Сотрудничество OMP недоступно",
      terminals: "Открыть терминал",
  ...
  importSession: {
    ...
    title: "Импортировать сессию OMP",
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Архивирование недоступно: это рабочее пространство не было создано как worktree OhMyPCode.",
  ...
  desktop: {
    ...
    quitting: {
      title: "Завершение работы OhMyPCode...",
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Разрешить OhMyPCode запускать и останавливать встроенный демон",
        ...
        registrationFailed:
          "Встроенный демон запущен, но OhMyPCode не удалось сохранить подключение к localhost. Выключите и снова включите управление демоном или добавьте localhost вручную.",
        pausedStopFailed:
          "Встроенное управление демоном было приостановлено, но OhMyPCode не смог остановить демон.",
        updateFailed: "Не удалось изменить настройки управления встроенным демоном.",
      },
      keepRunning: {
        title: "Продолжать работу демона после выхода",
        hint: "Демон продолжит работать после выхода из OhMyPCode",
      },
      logs: {
        title: "Файл журнала",
    ...
    rosetta: {
      ...
      runningIntel: "Вы используете сборку OhMyPCode для Intel через Rosetta на Apple Silicon.",
      highCpu:
    ...
    permissions: {
      ...
      testNotification: {
        title: "Тест уведомлений OhMyPCode",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Не удалось установить OhMyPCode CLI.",
      },
    },
  },
  rootError: {
    title: "В OhMyPCode возникла проблема.",
  ...
  openProject: {
    tiles: {
      ...
      importSession: {
        title: "Импортировать сессию OMP",
        description: "Откройте сеанс OMP, начатый в терминале",
      },
      connectProviders: {
        title: "Подключить провайдеров",
        description: "Войдите в Anthropic, OpenAI, OpenRouter и другие",
      },
      pairDevice: {
        title: "Подключить устройство",
        description: "Подключите приложение Paseo для iPhone к этому хосту",
      },
    },
    ompGithub: "Oh My Pi на GitHub",
  },
  projectPicker: {
  ...
  onboarding: {
    title: "Добро пожаловать в OhMyPCode",
    subtitle: "Подключитесь к компьютеру, на котором запущен OMP",
    actions: {
      settings: "Настройки",
    },
  },
  ...
  pairing: {
    ...
    direct: {
      title: "Прямое подключение",
      helper: "Введите адрес сервера OhMyPCode.",
      fields: {
        host: "Хост",
        port: "Порт",
        password: "Пароль",
    ...
    remoteSsh: {
      title: "Удалённый SSH",
      helper: "Подключитесь к демону OhMyPCode на удалённом хосте.",
      fields: {
        target: "Хост SSH",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Узнать, как работает ретранслятор OhMyPCode",
      ...
      updateRequired: "Обновите этот хост, чтобы включить ретранслятор.",
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "выполнен {{count}} вызов OhMyPCode",
      other: "выполнены вызовы OhMyPCode ({{count}})",
    },
    and: "и",
  },
  renameModal: {
  ...
  ompProviders: {
    ...
    disconnectConfirm: "Отключить {{name}} от OMP?",
    disconnectInTui: "Отключитесь с помощью /logout в OMP TUI",
    stillConnected: "Подключение всё ещё активно через переменную среды или models.yml",
    updateHost: "Обновите этот хост для управления провайдерами моделей OMP",
    ...
    empty: "Провайдеры не найдены",
    noneConnected: "Подключите провайдера моделей, чтобы начать использовать OMP",
    yes: "Да",
    no: "Нет",
    picker: {
      connect: "Подключить провайдера моделей",
    },
  },
  ompStatistics: {
    errors: {
      hostDisconnected: "Хост не подключён",
      updateHost: "Обновите хост, чтобы загрузить статистику OMP",
      unavailable: "Статистика OMP недоступна",
    },
  },
  settings: {
    title: "Настройки",
    ...
    notifications: {
      ...
      sentDescription: "OhMyPCode передал уведомление операционной системе.",
    ...
    metadataGeneration: {
      ...
      description:
        "Выберите модель, которую OhMyPCode будет использовать для названий рабочих пространств и веток, сообщений коммитов и черновиков PR",
      selection: "Выбор модели",
      automatic: "Автоматически",
      preferred: "Вручную",
      automaticHint: "OhMyPCode выбирает быструю доступную модель",
      preferredHint: "Выберите модель, которую использует OhMyPCode",
      model: "Модель",
      fallbackHint: "Если она недоступна, OhMyPCode использует другую доступную модель",
      docs: "Документация",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Вкладки браузера в OhMyPCode используют общие данные входа и данные сайтов.",
    ...
    about: {
      ...
      releaseChannel: {
        label: "Канал выпуска",
        description:
          "Переключитесь на бета-канал, чтобы раньше получать обновления и помогать развивать OhMyPCode.",
        stable: "Стабильный",
        beta: "Бета",
      },
      updates: {
        ...
        installMessage: "Это обновит OhMyPCode на этом компьютере.",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Обновить навыки OhMyPCode?",
        updateFallback: "Встроенные навыки будут синхронизированы с этим хостом.",
        uninstallTitle: "Удалить навыки OhMyPCode?",
        uninstallMessage:
          "Удаляет все навыки оркестрации OhMyPCode из ~/.agents, ~/.claude и ~/.codex на этом хосте.",
      ...
      orchestration: {
        ...
        enableTools: {
          title: "Включить инструменты OhMyPCode",
          hint: "Агенты смогут управлять worktree, агентами и расписаниями.",
          accessibilityLabel: "Добавить инструменты OhMyPCode",
        },
        systemPrompt: {
      ...
      ompCollab: {
        title: "Совместная работа OMP",
        description: "Делитесь активными хостами OMP или существующей сессией OMP.",
        securityNote:
          "Ссылки — это зашифрованные учётные данные, доступные владельцу. Они копируются напрямую и не отображаются в приложении.",
        openUsage: "Открыть использование",
        refreshHosts: "Обновить хосты",
        hostDisconnected: "Хост не подключён",
        hostDisconnectedHint: "Подключитесь к хосту для управления совместной работой OMP.",
        updateRequired: "Требуется обновление хоста",
        updateRequiredHint:
          "Обновите хост, чтобы включить совместную работу OMP и зашифрованный общий доступ.",
        listFailed: "Не удалось получить список хостов OMP",
        listFailedHint: "Попробуйте ещё раз обновить список активных хостов.",
        activeHosts: "Активные хосты совместной работы",
        refreshPrompt: "Обновите список, чтобы найти запущенные хосты OMP.",
        noActiveHosts: "Активные хосты совместной работы OMP не найдены.",
        savedSessions: "Сохранённые сессии OMP",
        savedSessionsHint: "Создайте ссылку на зашифрованный снимок существующей сессии OMP.",
        noSavedSessions: "Нет сессий OMP с сохранённым идентификатором.",
        participants: "Участников: {{count}}",
        busy: "Занят",
        inputRequired: "Требуется ввод",
        reconnecting: "Переподключение к ретранслятору",
        viewOnly: "Только просмотр",
        controlAvailable: "Доступно управление",
        viewOnlyHint: "Этот хост разрешает только ссылки для просмотра.",
        hostFallbackWithPid: "Хост OMP · PID {{pid}}",
        hostFallback: "Хост OMP",
        copyViewLink: "Копировать ссылку просмотра",
        copyControlLink: "Копировать ссылку управления",
        sessionFallback: "Сессия OMP · {{id}}",
        copyEncryptedShare: "Копировать зашифрованную ссылку",
        viewLinkCopied: "Ссылка только для просмотра",
        controlLinkCopied: "Ссылка управления",
        encryptedShareCopied: "Зашифрованная ссылка на сессию",
        shareFailed: "Не удалось создать ссылку для общего доступа.",
      },
      daemon: {
        rename: {
        ...
        restart: {
          ...
          offlineMessage:
            "Этот хост не в сети. OhMyPCode переподключится автоматически. Дождитесь подключения перед перезапуском.",
          requestFailedTitle: "Ошибка",
          requestFailedMessage:
            "Не удалось отправить запрос на перезапуск. OhMyPCode переподключается автоматически. Повторите попытку, когда хост появится в сети.",
          dialogFailedMessage: "Не удалось открыть диалог подтверждения перезапуска.",
        },
        update: {
          desktopManagedHint:
            "Этот демон управляется OhMyPCode Desktop. Обновите OhMyPCode Desktop на хосте.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "OhMyPCode управляет процессом и назначает порт через переменную $PASEO_PORT.",
        actions: {
          add: "Добавить скрипт",
          edit: "Редактировать",
          remove: "Удалить",
      ...
      metadata: {
        title: "Генерация метаданных",
        info: "Инструкции для этого проекта, добавляемые в промпты ИИ, с помощью которых OhMyPCode генерирует метаданные. Используйте их, чтобы соблюдать принятые в команде правила именования веток, оформления коммитов и формата PR.",
