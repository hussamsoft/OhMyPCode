...
function WebLogoShimmer({ color }: { color: string }) {
  ...
  const shimmerStyle = useMemo(
    () => ({
      width: LOGO_SIZE,
      height: LOGO_SIZE,
      WebkitMaskImage: `url("data:image/svg+xml,${encodeURIComponent(`<svg xmlns='http://www.w3.org/2000/svg' width='${LOGO_SIZE}' height='${LOGO_SIZE}' viewBox='0 0 120 90' preserveAspectRatio='xMidYMid meet'><rect x='10' y='8' width='100' height='12' rx='2' fill='black'/><rect x='25' y='20' width='12' height='62' rx='2' fill='black'/><rect x='75' y='20' width='12' height='45' rx='2' fill='black'/><rect x='71' y='55' width='20' height='16' rx='3' fill='black'/><rect x='76' y='59' width='3' height='8' rx='1' fill='black'/><rect x='82' y='59' width='3' height='8' rx='1' fill='black'/><circle cx='18' cy='14' r='2' fill='black'/><circle cx='102' cy='14' r='2' fill='black'/></svg>`)}")`,
  ...
  const maskElement = useMemo(
    () => (
      <View style={styles.shimmerMask}>
        <OmpLogo size={LOGO_SIZE} color="#000000" />
      </View>
    ),
    [],
  );
    ...
    <MaskedView style={trackStyle} maskElement={maskElement}>
      <View style={trackStyle}>
        <View style={styles.nativeShimmerBase}>
          <OmpLogo size={LOGO_SIZE} color={color} />
        </View>
