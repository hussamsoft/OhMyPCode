...
describe("web virtualization test overrides", () => {
  it("uses defaults unless explicit positive integer overrides are present", () => {
    ...
    const previousThreshold =
      globalWithOverrides.__OMPCODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD;
    const previousMounted = globalWithOverrides.__OMPCODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS;

    try {
      delete globalWithOverrides.__OMPCODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD;
      delete globalWithOverrides.__OMPCODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS;
      ...
      globalWithOverrides.__OMPCODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD = 6;
      globalWithOverrides.__OMPCODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = 4;
      ...
      if (previousThreshold === undefined) {
        ...
        globalWithOverrides.__OMPCODE_E2E_WEB_PARTIAL_VIRTUALIZATION_THRESHOLD = previousThreshold;
      }
      if (previousMounted === undefined) {
        delete globalWithOverrides.__OMPCODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS;
      } else {
        globalWithOverrides.__OMPCODE_E2E_WEB_MOUNTED_RECENT_STREAM_ITEMS = previousMounted;
      }
    }
  });
});
