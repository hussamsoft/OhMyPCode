// Web/Electron variant: drops the mobile-panels gesture runtime. The
// CompactExplorerOpenGestureSurface becomes a plain wrapper that ignores the
// edge-swipe handler — narrow-width web/electron has no swipe-to-open explorer.
...
import { usePanelStore, selectIsCompactFileExplorerOpen } from "@/stores/panel-store";
...
function useActiveCompactExplorerSidebarModel(
  ...
  const isExplorerActive = usePanelStore(selectIsCompactFileExplorerOpen);
