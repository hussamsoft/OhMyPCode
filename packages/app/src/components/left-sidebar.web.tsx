// Web/Electron variant: drops the mobile-panels gesture runtime (no swipe-to-close
// affordance in the <=500px width range on these platforms). The desktop sidebar
// resize gesture is independent of mobile-panels and remains in this build.
