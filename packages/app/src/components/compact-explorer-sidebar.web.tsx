// Web/Electron variant: drops the mobile-panels gesture runtime. The overlay-mode
// CompactExplorerSidebar renders without a close-swipe gesture on these platforms.
...
export function CompactExplorerSidebar({
  ...
  // Web/Electron has no on-screen keyboard, so the animated keyboard shift style
  // is intentionally unused here (the native variant applies it to the overlay).
