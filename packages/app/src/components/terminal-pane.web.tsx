...
// open-gesture blocker hook is only meaningful on native (it gates the
// swipe-to-open file explorer while the terminal has a text selection).
...
} from "@ohmypcode/protocol/terminal-input-mode";
