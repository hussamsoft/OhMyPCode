 ...
 * as before.
 */
import { FORGE_DEFINITIONS, getForgeDefinitionOrNeutral } from "@ohmypcode/protocol/forge-manifest";
import { normalizeHost, parseGitRemoteLocation } from "@ohmypcode/protocol/git-remote";
import type { ForgeAuthState } from "@ohmypcode/protocol/messages";
import {
  buildForgeBlobUrl,
