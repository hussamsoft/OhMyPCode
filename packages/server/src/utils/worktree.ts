...
import { PaseoConfigSchema, type PaseoConfig } from "@ohmypcode/protocol/paseo-config-schema";
import {
...
export { slugify, validateBranchSlug } from "@ohmypcode/protocol/branch-slug";
