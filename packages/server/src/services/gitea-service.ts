import { z } from "zod";
import { CHECK_TRAIT_ACTION_REQUIRED, CHECK_TRAIT_WARNING } from "@ohmypcode/protocol/check-traits";
import { mapGiteaCommitState } from "@ohmypcode/protocol/gitea-status";
